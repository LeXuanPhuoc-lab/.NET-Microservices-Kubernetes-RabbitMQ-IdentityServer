...
namespace AuctionService.Data
{
    public static class InitialiserExtension
    {
        ...
        {
            // Create IServiceScope that can be used to resolve scope servicees
    ...
    public class DatabaseInitialiser
    {
        ...
        // private readonly AuctionDbContext _context;
        public DatabaseInitialiser(AuctionDbContext context)
        {
            _context = context;
        }
        ...
        public async Task TrySeedAsync()
        {
            try
            {
                ...
                {
                    Console.WriteLine("Already have data - don't need to seed");
                    return;
                }
